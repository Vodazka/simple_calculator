import tkinter as tk #tkinter looks cool
calculation =""
...
def evaluate_calculation():
    ...
    try:
        ...
        clear_field() #?
        text_result.insert(1.0,"Oppsie") # in case there is an invalid calculation inserted
...
root=tk.Tk()
root.geometry("300x326") #size of the window
text_result=tk.Text(root, height=2, width=16, font=("Times 28 italic")) # ? text config. affect window
text_result.grid(columnspan=5) #text goes across 5 columns
#--------------CHANGE TEXT COLOR PLS-----------------------------

btn_1=tk.Button(root, text="1", command=lambda:add_to_calculation(1), width=5, font=("Times",18)) #lambda refers to functiom != call it.
...
btn_clear=tk.Button(root, text="C", command=clear_field, width=11, font=("Times",18)) #pass the funcion as an entity so != lambda or ()
